...
public class LITMagicPepperAndFireWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(LITMagicPepperAndFireWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/LITMagicPepperAndFireWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/LITMagicPepperAndFireWLAIW/InitOutcome.xml").getDocumentElement();
